...
with st.sidebar:
    st.markdown(
        ...
        .hamburger-icon { font-size: 1.5rem; color: #111827; line-height: 1; }
        .menu-text { font-size: 1.25rem; font-weight: 600; color: #111827; }
        </style>
    ...
    menu = option_menu(
        ...
        styles={
            ...
            "nav-link": {"font-size": "14.5px", "text-align": "left", "margin": "6px 0px", "--hover-color": "#E5E7EB", "border-radius": "8px", "color": "#111827"},
            "nav-link-selected": {"background-color": "#D1D5DB", "color": "#111827", "font-weight": "bold", "border-radius": "8px"},
        },
    )
